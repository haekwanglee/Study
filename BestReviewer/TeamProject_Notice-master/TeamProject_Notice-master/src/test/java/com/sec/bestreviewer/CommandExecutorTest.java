...
class CommandExecutorTest {
    ...
    void queryExecutorReturnsResultString() {
        ...
        final List<String> params = Arrays.asList("18050301", "KYUMOK KIM", "CL2", "010-9777-6055", "19980906");
    ...
    private void deleteCommandWithPrintOption(int count) {
        ...
        when(employeeStore.delete("name", "KYUMOK KIM")).thenReturn(employeeList);
    ...
    private List<Employee> getEmployees(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            employeeList.add(
                    new Employee(employeeNumber, "SEO KFI", "CL1", "010-1234-5678", "20190101"));
        }
        return employeeList;
    }
    ...
    void testDeleteCommandReturnsSortedEmployeeList() {
        ...
        when(employeeStore.delete("name", "KYUMOK KIM")).thenReturn(reversedEmployeeList);
