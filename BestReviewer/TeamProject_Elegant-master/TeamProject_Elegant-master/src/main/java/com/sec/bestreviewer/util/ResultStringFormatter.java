...
public class ResultStringFormatter {
    ...
    public static List<String> getEmployeeListToFormattedString(List<Employee> employeeList,
                                                                CommandType commandType, int count) {
    ...
    public static String getEmployeeToFormattedString(CommandType commandType, Employee employee) {
    ...
    public static List<String> getEmployeeListToFormattedString(List<Employee> employeeList, CommandType commandType) {
